...
public partial class Contents_ReclMltpl1New : System.Web.UI.Page
{
    ...
    private void FillTreasDet()
    {
        ...
        dsRecM = recd.GetTreasuryDataMonthWiseNewNew(rec);
    ...
    {
        btnBack.PostBackUrl = "~/Contents/ReclNew.aspx";
    }
    ...
    {
        btnDet.PostBackUrl = "~/Contents/ReclMltpl2New.aspx";
    }
}
