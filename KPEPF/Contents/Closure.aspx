<%@ Page Language="C#" MasterPageFile="~/Contents/MasterPage.master" AutoEventWireup="true" CodeFile="Closure.aspx.cs" Inherits="Contents_Closure" Title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="contentPholder" Runat="Server">


  <asp:UpdatePanel ID="updatepanel" runat= "server">
 <ContentTemplate>
<TABLE id="TABLE1" onclick="return "><TBODY><TR><TD class="TdMnHead" colSpan=4 ><asp:Label id="lblHead" class="MnHead" runat="server" Text="Closure"></asp:Label></TD></TR><TR><TD style="WIDTH: 866px; COLOR: black; BACKGROUND-COLOR: #ccd0e6" align=center colSpan=4 height=26 ;><asp:Label id="Label5" class="p1" runat="server" Text="Basic Details"></asp:Label></TD></TR><TR><TD style="WIDTH: 166px"><asp:Label id="Inward" class="p1" runat="server" Text="Label">Inward No</asp:Label> </TD><TD style="WIDTH: 166px"><asp:TextBox id="txtInwNo" oncopy="return false" oncut="return false" onkeypress="return  isNumberKey(event)" onpaste="return false" runat="server" CssClass="txtNumeric" MaxLength="3" AutoPostBack="True" OnTextChanged="txtInwNo_TextChanged"></asp:TextBox> </TD><TD style="WIDTH: 166px"><asp:Label id="Label2" class="p1" runat="server" Text="Account No. "></asp:Label> </TD><TD style="WIDTH: 166px"><asp:TextBox id="txtEmpID" oncopy="return false" oncut="return false" onkeypress="return  isNumberKey(event)" onpaste="return false" runat="server" Width="149px" CssClass="txtNumeric" MaxLength="5" AutoPostBack="True" OnTextChanged="txtEmpID_TextChanged"></asp:TextBox> <asp:Button id="Button1" onclick="Button1_Click" runat="server" text="..."></asp:Button> </TD></TR><TR><TD style="WIDTH: 166px"><asp:Label id="FileNo" class="p1" runat="server" Text="Label">File No</asp:Label> </TD><TD style="WIDTH: 166px"><asp:Label id="txtFileNo" runat="server" Enabled="False"></asp:Label> </TD><TD style="WIDTH: 166px"><asp:Label id="lblNameAppl" class="p1" runat="server" Text="Name of Applicant"></asp:Label> </TD><TD style="WIDTH: 166px"><asp:Label id="lblNameApplDisp" class="p1" runat="server" Text="<<>>"></asp:Label> </TD></TR><TR><TD style="WIDTH: 166px"><asp:Label id="AppDate" class="p1" runat="server" Text="Label">Application Date</asp:Label> </TD><TD style="WIDTH: 166px"><asp:TextBox id="txtAppDate" runat="server" CssClass="datePicker" OnTextChanged="txtAppDate_TextChanged"></asp:TextBox> </TD><TD style="WIDTH: 166px" align=left><asp:Label id="lblAccNo" class="p1" runat="server" Text="Designation"></asp:Label> </TD><TD style="WIDTH: 166px" align=left><asp:Label id="lblDesig" class="p1" runat="server" Text="<<>>"></asp:Label> </TD></TR><TR><TD style="WIDTH: 866px; COLOR: black; BACKGROUND-COLOR: #ccd0e6" align=center colSpan=4 height=26 ;><asp:Label id="Label4" class="p1" runat="server" Text="Closure Details"></asp:Label></TD></TR><TR><%--<td></td>--%><TD style="HEIGHT: 22px" align=left colSpan=2><asp:Label id="lblPur" class="p1" runat="server" Text="Reason for quitting"></asp:Label></TD><TD style="WIDTH: 166px; HEIGHT: 22px" align=left><asp:DropDownList id="ddlPurpose" oncontextmenu="fnJumpSize(this);" runat="server" Tooltip="Right click to view in full" onchange="fnc(this);" width="155" OnSelectedIndexChanged="ddlPurpose_SelectedIndexChanged"></asp:DropDownList></TD><%--<td  align="left"><asp:Label id="Label1" class="p1" runat="server" Text="Consolidated TA Amount"></asp:Label></td>
        <td  align=left><asp:TextBox id="lblConsAmt" class="p2" runat="server" onkeypress="return  isNumberKey(event)" CssClass="txtNumeric" MaxLength="6"></asp:TextBox></td>--%></TR><TR><%--<td></td>--%><TD align=left colSpan=2><asp:Label id="lblAmt" class="p1" runat="server" Text="Date of drawal of last salary"></asp:Label></TD><TD style="WIDTH: 166px" align=left><asp:TextBox id="txtLastSlry" onkeypress="return" runat="server" MaxLength="15" AutoPostBack="True" Cssclass="txtNumericFloat"></asp:TextBox> </TD><%--<td  align="left"><asp:Label id="Label3" class="p1" runat="server" Text="Monthly Repayment"></asp:Label></td>
        <td  align=left><asp:TextBox id="lblRepay" class="p2" runat="server" onkeypress="return  isNumberKey(event)" CssClass="txtNumeric" MaxLength="5"></asp:TextBox></td>--%></TR><TR><%-- <td></td>--%><TD align=left colSpan=2><asp:Label id="lblInst" class="p1" runat="server" Text="No. and date of last chalan remitted"></asp:Label></TD><TD style="WIDTH: 166px" align=left><asp:TextBox id="txtLastChalan" onkeypress="return  isNumberKey(event)" runat="server" CssClass="datePicker" MaxLength="15" AutoPostBack="True"></asp:TextBox></TD></TR><TR><TD align=left colSpan=2><asp:Label id="lblAdmAmt" class="p1" runat="server" Text="Date of quitting service"></asp:Label></TD><TD style="WIDTH: 166px" align=left><asp:TextBox id="txtDateQuitting" runat="server" MaxLength="15" AutoPostBack="True" cssclass="datePicker"></asp:TextBox></TD></TR><TR><TD align=left colSpan=2><asp:Label id="lblPaymentOffice" class="p1" runat="server" text="Office through which payment is made"></asp:Label></TD><TD style="WIDTH: 166px"><asp:TextBox id="txtPaymentOffice" runat="server" MaxLength="10"></asp:TextBox></TD></TR><TR><TD></TD><TD align=right><asp:Button id="btnSave" onclick="btnSave_Click" runat="server" Width="56px" Text="Save"></asp:Button> </TD></TR><TR><TD style="WIDTH: 494px" colSpan=4><asp:LinkButton id="btnSec" onclick="btnSec_Click" runat="server" Width="138px" ForeColor="Blue" Font-Bold="True" Text="Back to inbox" Height="23px" PostBackUrl="~/Contents/InboxService.aspx" Visible="False"></asp:LinkButton></TD></TR></TBODY></TABLE>
