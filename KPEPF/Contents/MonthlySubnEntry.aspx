<%@ Page Language="C#" MasterPageFile="~/Contents/MasterPage.master" AutoEventWireup="true" CodeFile="MonthlySubnEntry.aspx.cs" Inherits="Contents_MonthlySubnEntry" Title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="contentPholder" Runat="Server">
    <asp:UpdatePanel id="UpdatePanel1" runat="server">
 <ContentTemplate>
<TABLE style="BACKGROUND: white" width="100%" border=0><TBODY><TR><TD style="HEIGHT: 20px" class="TdMnHead" colSpan=4><asp:Label id="lblHead" class="MnHead" runat="server" Text="Monthly Subscription"></asp:Label> </TD></TR><TR><TD style="HEIGHT: 14px" colSpan=3>&nbsp;</TD></TR><TR align=center><TD><asp:Label id="lblYear" class="p1" runat="server" Text="Year"></asp:Label> <asp:DropDownList id="ddlYear" runat="server" OnSelectedIndexChanged="ddlYear_SelectedIndexChanged" AutoPostBack="True"></asp:DropDownList> </TD><TD><asp:Label id="lblMonth" class="p1" runat="server" Text="Month"></asp:Label> <asp:DropDownList id="ddlMonth" runat="server" OnSelectedIndexChanged="ddlMonth_SelectedIndexChanged" AutoPostBack="True"></asp:DropDownList> <asp:Label id="lblStatus" class="p1" runat="server"></asp:Label> </TD></TR><TR><TD>&nbsp;</TD></TR><TR><TD style="HEIGHT: 24px" class="TdSbHead" colSpan=4><asp:Label id="lblDet" class="Head1" runat="server" Text="Chalan Details"></asp:Label> </TD></TR><TR align=center><TD colSpan=4><asp:Panel id="pnlChal1" runat="server" Width="70%" Visible="true"><TABLE style="WIDTH: 92%"><TBODY><TR align=center><TD style="WIDTH: 128px; HEIGHT: 34px" align=left><asp:Label id="lblBank" runat="server" CssClass="p1" text="Treasury"></asp:Label></TD><TD style="WIDTH: 143px; HEIGHT: 34px" align=left><asp:Label id="lblTreas" runat="server" Width="100px" CssClass="p1" Font-Names="Verdana" Font-Size="10pt" text="..." BorderColor="#404040"></asp:Label> </TD><TD style="HEIGHT: 34px" align=left><asp:Label id="lblChlNo" runat="server" Width="102px" CssClass="p1" text="Chalan No."></asp:Label></TD><TD style="HEIGHT: 34px" align=left><asp:TextBox id="txtChlNo" oncopy="return false" oncut="return false" onkeypress="return  isNumberKey(event)" onpaste="return false" runat="server" AutoPostBack="True" CssClass="txtNumeric" OnTextChanged="txtChlNo_TextChanged" MaxLength="9" width="130px"></asp:TextBox> </TD></TR><TR><TD style="WIDTH: 128px" align=left><asp:Label id="lblChlAmt" runat="server" CssClass="p1" text="Chalan Amount"></asp:Label></TD><TD align=left>
    <asp:TextBox id="txtChlAmt" oncopy="return false" oncut="return false" onkeypress="return  isNumberKey(event)" onpaste="return false" runat="server" CssClass="txtNumeric" MaxLength="8" text="0" width="94px"></asp:TextBox> </TD><TD style="WIDTH: 143px" align=left><asp:Label id="lblChldt" runat="server" CssClass="p1" text="Chalan Date"></asp:Label> </TD><TD align=left><asp:TextBox id="txtChlDt" runat="server" Width="129px" AutoPostBack="True" CssClass="datePicker" OnTextChanged="txtChlDt_TextChanged" MaxLength="10"></asp:TextBox> </TD></TR><TR align=center><TD colSpan=4><asp:Button id="btnNew" onclick="btnNew_Click" runat="server" Width="50px" Text="New"></asp:Button>&nbsp;&nbsp;&nbsp; <asp:Button id="btnAdd" onclick="btnAdd_Click" runat="server" Width="50px" Text="Save"></asp:Button>


&nbsp;&nbsp;&nbsp; <asp:Button id="btnDel" onclick="btnDel_Click" runat="server" Width="50px" onclientclick="return DeleteItem()" Text="Delete"></asp:Button>

                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         </TD></TR><TR><TD align=center colSpan=8><asp:GridView id="gdvChalan" runat="server" Width="700px" ForeColor="#333333" OnSelectedIndexChanged="gdvChalan_SelectedIndexChanged" ShowFooter="True" GridLines="None" CellPadding="2" AutoGenerateColumns="False" Font-Names="Verdana" Font-Size="10pt" CellSpacing="5">
...
</asp:GridView> </TD></TR></TBODY></TABLE></asp:Panel></TD></TR><TR><TD>&nbsp;</TD></TR><TR><TD style="HEIGHT: 24px" class="TdSbHead" colSpan=4><asp:Label id="Label1s" class="Head1" runat="server" Text="Schedule Details"></asp:Label> </TD></TR><TR><TD style="HEIGHT: 22px" colSpan=3><asp:Label id="lblCntText" class="p1" runat="server" Text="No. of Rows"></asp:Label> <asp:TextBox id="txtCnt" oncopy="return false" oncut="return false" onkeypress="return  isNumberKey(event)" onpaste="return false" runat="server" Width="78px" Text="1" AutoPostBack="True" CssClass="txtNumeric" OnTextChanged="txtCnt_TextChanged" MaxLength="2"></asp:TextBox> <asp:Label id="txtHddn" runat="server" Width="78px" Text="0" Visible="False"></asp:Label> <asp:Label id="lblMisMatch" runat="server" Width="78px" Text="" Visible="False" CssClass="p4"></asp:Label> </TD></TR><TR><TD style="WIDTH: 100%" colSpan=4>
    <DIV style="OVERFLOW-X: auto; WIDTH: 900px">
    <asp:GridView id="gdvMonthlySubn" runat="server" Width="100%" ForeColor="#333333" ShowFooter="True" GridLines="None" CellPadding="2" AutoGenerateColumns="False" Font-Names="Verdana" Font-Size="10pt" CellSpacing="5">
<RowStyle BackColor="#EFF3FB"></RowStyle>
<Columns>
<asp:BoundField DataField="SlNo" HeaderText="SlNo"></asp:BoundField>
<asp:TemplateField HeaderText="Acc.  No."><ItemTemplate>
<asp:TextBox id="txtAccNo" oncopy="return false" oncut="return false" onkeypress="return  isNumberKey(event)" onpaste="return false" runat="server" Width="76px" AutoPostBack="True" MaxLength="8" OnTextChanged="txtAccNo_TextChanged" CssClass="txtNumeric" __designer:wfdid="w5"></asp:TextBox> 
</ItemTemplate>
</asp:TemplateField>
...
<asp:TextBox id="txtSubn" oncopy="return false" oncut="return false" onkeypress="return  isNumberKey(event)" onpaste="return false" runat="server" Width="60px" AutoPostBack="True" CssClass="txtNumeric" OnTextChanged="txtSubn_TextChanged" MaxLength="8"></asp:TextBox> 
</ItemTemplate>

<ItemStyle HorizontalAlign="Right"></ItemStyle>
</asp:TemplateField>
<asp:TemplateField HeaderText="Repay ment"><ItemTemplate>
<asp:TextBox id="txtRep" oncopy="return false" oncut="return false" onkeypress="return  isNumberKey(event)" onpaste="return false" runat="server" Width="60px" AutoPostBack="True" CssClass="txtNumeric" OnTextChanged="txtRep_TextChanged" MaxLength="8"></asp:TextBox> 
</ItemTemplate>

<ItemStyle HorizontalAlign="Right"></ItemStyle>
</asp:TemplateField>
<asp:TemplateField HeaderText="Arrear PF"><ItemTemplate>
<asp:TextBox id="txtArr1" oncopy="return false" oncut="return false" onkeypress="return  isNumberKey(event)" onpaste="return false" runat="server" Width="60px" AutoPostBack="True" CssClass="txtNumeric" OnTextChanged="txtArr1_TextChanged" MaxLength="8"></asp:TextBox> 
</ItemTemplate>

<ItemStyle HorizontalAlign="Right"></ItemStyle>
</asp:TemplateField>
<asp:TemplateField HeaderText="Arrear DA"><ItemTemplate>
<asp:TextBox id="txtArr2" oncopy="return false" oncut="return false" onkeypress="return  isNumberKey(event)" onpaste="return false" runat="server" Width="60px" AutoPostBack="True" CssClass="txtNumeric" OnTextChanged="txtArr2_TextChanged" MaxLength="8"></asp:TextBox> 
</ItemTemplate>

<ItemStyle HorizontalAlign="Right"></ItemStyle>
</asp:TemplateField>
<asp:TemplateField HeaderText="Arrear Pay"><ItemTemplate>
<asp:TextBox id="txtArr3" oncopy="return false" oncut="return false" onkeypress="return  isNumberKey(event)" onpaste="return false" runat="server" Width="60px" AutoPostBack="True" CssClass="txtNumeric" OnTextChanged="txtArr3_TextChanged" MaxLength="8"></asp:TextBox> 
</ItemTemplate>
...
<asp:Label id="lblSched" runat="server" Text="0" __designer:wfdid="w6"></asp:Label> 
</ItemTemplate>
</asp:TemplateField>
<asp:TemplateField HeaderText="Delete"><ItemTemplate>
<asp:ImageButton id="btndeleteCr" onclick="btnDeleteCr_Click" runat="server" __designer:wfdid="w4" ImageUrl="~/images/removerow.gif" onclientclick="return DeleteItem()"></asp:ImageButton> 
</ItemTemplate>
...
<AlternatingRowStyle BackColor="White"></AlternatingRowStyle>
        ...
        </DIV> </TD></TR><TR><TD style="HEIGHT: 24px" align=center colSpan=4><asp:Button id="btnFinal" onclick="btnFinal_Click" runat="server" Width="96px" Text="Save" OnClientClick="return ConfirmMsg();"></asp:Button> <asp:Button id="btnPrint" onclick="btnPrint_Click" runat="server" Width="96px" Text="Print" Visible="False" Enabled="false "></asp:Button> </TD></TR><TR><TD style="HEIGHT: 33px" colSpan=4><asp:LinkButton id="btnSec" onclick="btnSec_Click" runat="server" Width="138px" ForeColor="Blue" Font-Bold="True" Text="Back to inbox" Visible="False" PostBackUrl="~/Contents/InboxMonthlyTrn.aspx" Height="23px"></asp:LinkButton> </TD></TR></TBODY></TABLE>
</ContentTemplate>
</asp:UpdatePanel>
<%--    &nbsp;--%>
