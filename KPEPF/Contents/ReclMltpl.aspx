<%@ Page Language="C#" MasterPageFile="~/Contents/MasterPage.master" AutoEventWireup="true" CodeFile="ReclMltpl.aspx.cs" Inherits="Contents_ReclMltpl" Title="Untitled Page" %>
...
<AlternatingRowStyle BackColor="White"></AlternatingRowStyle>
</asp:GridView> </TD></TR><TR><TD colSpan=2>&nbsp;</TD></TR><TR><TD align=center colSpan=2><asp:Label id="lblYearDAG" runat="server" Text="..." CssClass="p4" visible="false"></asp:Label> </TD></TR><TR><TD align=center colSpan=2><asp:GridView id="gdvRecAGMth" runat="server" Width="900px" ForeColor="#333333"   Font-Names="Verdana" Font-Size="10pt" CellSpacing="5" CellPadding="2" GridLines="None" AutoGenerateColumns="False" ShowFooter="True" OnRowCreated="gdvRecAGMth_RowCreated" Visible="False">
<FooterStyle BackColor="#507CD1" ForeColor="White" Font-Bold="True"></FooterStyle>
<Columns>
<asp:BoundField DataField="chvMonth" HeaderText="Month">
<ItemStyle Width="45px" HorizontalAlign="Left"></ItemStyle>
...
<AlternatingRowStyle BackColor="White"></AlternatingRowStyle>
</asp:GridView> </TD></TR><TR align=center><TD colSpan=2><asp:Label id="Label1" runat="server" Text="KPEPF Account" CssClass="p1"></asp:Label> </TD></TR><TR align=center><TD style="WIDTH: 100%" colSpan=2><asp:GridView id="gdvRecPF" runat="server" Width="900px" ForeColor="#333333" Font-Names="Verdana" Font-Size="10pt" CellSpacing="5" CellPadding="2" GridLines="None" AutoGenerateColumns="False" OnRowCreated="gdvRecPF_RowCreated" OnRowDataBound="gdvRecPF_RowDataBound">
<FooterStyle BackColor="#507CD1" ForeColor="White" Font-Bold="True"></FooterStyle>
<Columns>
...
<AlternatingRowStyle BackColor="White"></AlternatingRowStyle>
</asp:GridView> </TD></TR><TR><TD>&nbsp;</TD></TR><TR><TD align=center colSpan=2><asp:Label id="lblYearD" runat="server" Text="..." CssClass="p4"></asp:Label> </TD></TR><TR><TD align=center colSpan=2><asp:GridView id="gdvRecM" runat="server" Width="900px" ForeColor="#333333" Font-Names="Verdana" Font-Size="10pt" CellSpacing="5" CellPadding="2" GridLines="None" AutoGenerateColumns="False" ShowFooter="True" OnRowCreated="gdvRecM_RowCreated">
<FooterStyle BackColor="#507CD1" ForeColor="White" Font-Bold="True"></FooterStyle>
<Columns>
