<%@ Page Language="C#" MasterPageFile="~/Contents/MasterPage.master" AutoEventWireup="true" CodeFile="DPWithdrawal.aspx.cs" Inherits="Contents_DPWithdrawal" Title="Untitled Page" %>
...
<Columns>
    ...
    <asp:TemplateField HeaderText="Order Date" >
        <ItemTemplate>
            <asp:TextBox ID="txtOrdrDtDW" runat="server" MaxLength="10" Width="115px" Enabled="False" ReadOnly="True" AutoPostBack="True" OnTextChanged="txtOrdrDtDW_TextChanged"></asp:TextBox>
        </ItemTemplate>
    </asp:TemplateField>
