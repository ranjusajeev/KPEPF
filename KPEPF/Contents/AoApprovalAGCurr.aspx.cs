...
public partial class Contents_AoApprovalAGCurr : System.Web.UI.Page
{
    ...
    private void FillGrid(int flgApp)
    {
        ...
        SetGridDefault();
        dsApp = aoRecorrDAO.SelectApprovalCurrAG(aoRecorr);
        if (dsApp.Tables[0].Rows.Count > 0)
        {
            ...
            for (int i = 0; i < dsApp.Tables[0].Rows.Count; i++)
            {
                ...
                {
                    if (dsApp.Tables[0].Rows[i].ItemArray[4].ToString() == "2" || dsApp.Tables[0].Rows[i].ItemArray[4].ToString() == "0")
                    {
                        chkAppAss.Checked = true;
                        chkAppAss.Enabled = false;
                    }
    ...
    protected void btnOK_Click(object sender, EventArgs e)
    {
        for (int i = 0; i < gdvAOApprov.Rows.Count; i++)
        {
            ...
            if (chkAppAss.Checked == true)
            {
                ...
                aoRecorrDAO.UpdateflagAppAGCurr(aoRecorr);
            }
        }
