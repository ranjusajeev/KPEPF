<%@ Page Language="C#" MasterPageFile="~/Contents/MasterPage.master" AutoEventWireup="true" CodeFile="ServiceHistoryEntry.aspx.cs" Inherits="Contents_ServiceHistoryEntry" Title="Untitled Page" %>
...
<asp:GridView id="gdvService" runat="server" ForeColor="#333333" Font-Size="10pt" Font-Names="Verdana" AutoGenerateColumn="false" CellSpacing="5" AutoGenerateColumns="False" GridLines="None" CellPadding="2"><Columns>
...
<AlternatingRowStyle BackColor="White"></AlternatingRowStyle>
 ...
 </TD><TD colSpan=1></TD></TR><TR><TD style="HEIGHT: 24px" align=center colSpan=4><asp:Button id="Button2" onclick="btnSave1_Click" runat="server" Width="74px" Text="Save" Font-Size="10pt" Font-Names="Verdana"></asp:Button> </TD></TR><%--<tr>
