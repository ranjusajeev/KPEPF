...
<%@ page language="C#" masterpagefile="~/Contents/MasterPage.master" autoeventwireup="true" inherits="Contents_InboxService, App_Web_vxnq-4wi" %>
...
<TABLE style="WIDTH: 100%"><TBODY><TR><TD class="TdMnHead"><asp:Label id="lblHead" class="MnHead" runat="server" Text="Inbox-TA"></asp:Label> </TD></TR><TR><TD style="BACKGROUND-COLOR: #ccd0e6" align=center><asp:RadioButtonList id="rdApp" runat="server" ForeColor="Navy" Font-Size="10pt" Font-Names="Verdana" AutoPostBack="True" RepeatDirection="Horizontal" OnSelectedIndexChanged="rdApp_SelectedIndexChanged">
                ...
                </asp:RadioButtonList> </TD></TR><%--<tr>
            <td align="center" style="background-color: #ccd0e6; width: 882px;" >
                <asp:RadioButtonList ID="rdAmtTp" runat="server" AutoPostBack="True" Font-Names="Verdana"
                    Font-Size="10pt" ForeColor="Navy" 
                    RepeatDirection="Horizontal" OnSelectedIndexChanged="rdAmtTp_SelectedIndexChanged" >
                    <asp:ListItem Selected="True">Amount<75000</asp:ListItem>
                    <asp:ListItem>Amount>=75000</asp:ListItem>
                    <asp:ListItem>Amount>=200000</asp:ListItem>
                </asp:RadioButtonList>
            </td>
        </tr>--%><TR><TD style="WIDTH: 950px" align=center colSpan=2><asp:RadioButtonList id="rdAmtTp" runat="server" ForeColor="RoyalBlue" Font-Bold="True" Font-Size="10pt" Font-Names="Verdana" AutoPostBack="True" RepeatDirection="Horizontal" OnSelectedIndexChanged="rdAmtTp_SelectedIndexChanged" Enabled="true">
...
<asp:HyperLinkField HeaderText="Account No" DataTextField="chvPF_No" DataNavigateUrlFormatString="~/Contents/SubnChange.aspx?TAReqID={0}" DataNavigateUrlFields="numWithRequestID">
<ItemStyle HorizontalAlign="Left"></ItemStyle>
</asp:HyperLinkField>
<asp:BoundField DataField="chvName" HeaderText="Employee Name">
<ItemStyle HorizontalAlign="Left"></ItemStyle>
...
<%--<asp:TemplateField Visible="False" HeaderText="Reason for Return">
<ItemStyle HorizontalAlign="Left"></ItemStyle>
<ItemTemplate>
            <asp:TextBox ID="txtRsn" runat="server" MaxLength="50" Width="115px" Enabled="False" ReadOnly="True"></asp:TextBox>
