...
<%@ page language="C#" masterpagefile="~/Contents/MasterPage.master" autoeventwireup="true" inherits="Contents_SearchEmp, App_Web_vxnq-4wi" %>
...
<TABLE width="100%" border=0><TBODY><TR><TD class="TdMnHead" colSpan=2><asp:Label id="lblHead" class="MnHead" runat="server" Text="Search an Employee"></asp:Label></TD></TR><TR><TD style="WIDTH: 1118px; BACKGROUND-COLOR: #ccd0e6" align=center colSpan=2><asp:RadioButtonList id="rdView" runat="server" ForeColor="Navy" OnSelectedIndexChanged="rdView_SelectedIndexChanged" RepeatDirection="Horizontal" AutoPostBack="True" Font-Names="Verdana" Font-Size="10pt">
                ...
                </asp:RadioButtonList> </TD></TR><TR align=center><TD><asp:Label id="a" runat="server" ForeColor="Blue" Text="Account Number" Font-Names="Verdana" Font-Size="10pt"></asp:Label> <asp:TextBox id="txtValue" oncopy="return false" oncut="return false" onkeypress="return  isNumberKey(event)" onpaste="return false" runat="server" Width="161px" MaxLength="5" CssClass="txtNumeric"></asp:TextBox> <asp:Button id="btnFind" onclick="btnFind_Click" runat="server" Width="49px" Text="Find"></asp:Button></TD></TR><TR align=center><TD><asp:Label id="b" runat="server" ForeColor="Blue" Text="Name of Employee" Font-Names="Verdana" Font-Size="10pt" Visible="False"></asp:Label> <asp:TextBox id="txtValue1" runat="server" MaxLength="20" Visible="false"></asp:TextBox> <asp:Button id="btnFind1" onclick="btnFind1_Click" runat="server" Width="50px" Text="Find" Visible="false"></asp:Button></TD></TR><TR align=center><TD vAlign=top colSpan=2><asp:GridView id="gdvSearch" runat="server" ForeColor="#333333" Font-Names="Verdana" Font-Size="10pt" CellSpacing="5" GridLines="None" CellPadding="2" AutoGenerateColumns="False" Height="70px">
