...
<%@ page language="C#" masterpagefile="~/Contents/MasterPage.master" autoeventwireup="true" inherits="Contents_SetEmp, App_Web_zy0s82tr" %>
<%@ Register Src="MsgBox.ascx" TagName="MsgBox" TagPrefix="uc2" %>
<asp:Content ID="Content1" ContentPlaceHolderID="contentPholder" runat="server">
      <asp:UpdatePanel ID="updatepanel" runat= "server">
    <ContentTemplate>
<TABLE width="100%" border=0><TBODY><TR><TD class="TdMnHead" colSpan=2 height=26 ;><asp:Label id="lblHead" class="MnHead" runat="server" Text="Employee Mapping"></asp:Label></TD></TR></TBODY></TABLE><TABLE class="maintable" width="100%" border=0><TBODY><TR><TD style="WIDTH: 1118px; BACKGROUND-COLOR: #ccd0e6" align=center colSpan=2><asp:RadioButtonList id="optSearch" runat="server" ForeColor="Navy" Font-Size="10pt" Font-Names="Verdana" AutoPostBack="True" RepeatDirection="Horizontal" OnSelectedIndexChanged="optSearch_SelectedIndexChanged">
                    <asp:ListItem Selected="True">Account Number</asp:ListItem>
                    <asp:ListItem>Name</asp:ListItem>
                </asp:RadioButtonList> </TD></TR><TR><TD align=center><TABLE><TBODY><TR><TD><asp:TextBox id="txtValue" onkeypress="javascript:numericcheck();" runat="server" MaxLength="6" CssClass="txtNumeric" BorderWidth="2px" BorderStyle="Groove" BorderColor="#8080FF"></asp:TextBox></TD><TD><asp:Button id="btnFind" onclick="btnFind_Click" runat="server" Width="40px" Text="Find"></asp:Button></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE><TABLE class="maintable" width="100%" border=0><TBODY><TR><TD colSpan=2><asp:Label id="lbl1" runat="server" ForeColor="Navy" Text="Search Results" Font-Size="10pt" Font-Names="Verdana"></asp:Label></TD><TD colSpan=2><asp:Label id="lbl2" runat="server" ForeColor="Navy" Text="Existing List of Employees" Font-Size="10pt" Font-Names="Verdana"></asp:Label></TD></TR><TR width="45%"><TD vAlign=top align=right><asp:GridView id="gdvSearch" runat="server" ForeColor="#333333" Height="70px" Font-Size="10pt" Font-Names="Verdana" OnPageIndexChanging="gdvSearch_PageIndexChanging" AllowPaging="True" GridLines="None" CellPadding="2" AutoGenerateColumns="False" CellSpacing="5">
...
<HeaderStyle HorizontalAlign="Center"></HeaderStyle>
<ItemTemplate>
                    <asp:TextBox ID="txtOrdrNo" runat="server" Width="100px" />
...
</asp:GridView> </TD><TD width="8%"><asp:Button id="Button1" onclick="Button1_Click" runat="server" Width="30px" Font-Bold="True" Text=">" Visible="true"></asp:Button> </TD><TD vAlign=middle width="55%"><TABLE width="100%" border=0><TBODY><TR><TD vAlign=top><asp:GridView id="gdvEmp" runat="server" ForeColor="#333333" Font-Size="10pt" Font-Names="Verdana" GridLines="None" CellPadding="2" AutoGenerateColumns="False" CellSpacing="5">
<FooterStyle BackColor="#507CD1" ForeColor="White" Font-Bold="True"></FooterStyle>
<Columns>
