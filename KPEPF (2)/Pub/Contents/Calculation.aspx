<%@ page language="C#" masterpagefile="~/Contents/MasterPage.master" autoeventwireup="true" inherits="Contents_Calculation, App_Web_vxnq-4wi" title="Untitled Page" %>
...
<asp:BoundField DataField="chvCorrType" HeaderText="Correction Type"></asp:BoundField>
...
<asp:BoundField DataField="fltAmountBefore" HeaderText="Amount Before">
<ItemStyle HorizontalAlign="Right"></ItemStyle>
</asp:BoundField>
<asp:BoundField DataField="fltChalanAmt" HeaderText="Amount">
<ItemStyle HorizontalAlign="Right"></ItemStyle>
</asp:BoundField>
<asp:BoundField DataField="fltCalcAmount" HeaderText="Corrected amount">
<ItemStyle HorizontalAlign="Right"></ItemStyle>
</asp:BoundField>
</Columns>
