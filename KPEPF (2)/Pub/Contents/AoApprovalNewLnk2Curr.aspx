<%@ page language="C#" masterpagefile="~/Contents/MasterPage.master" autoeventwireup="true" inherits="Contents_AoApprovalNewLnk2Curr, App_Web_sldhjcan" title="Untitled Page" %>
...
</asp:GridView> </TD></TR><%--<TR><TD style="WIDTH: 46px" align=left><asp:Label id="Label12" runat="server" Width="88px" ForeColor="Blue" Font-Bold="True" Text="Schedule" Font-Size="10pt" Font-Names="Verdana"></asp:Label></TD><TD style="WIDTH: 103px"><asp:DropDownList id="ddlSched" tabIndex=4 runat="server" Width="160px" AutoPostBack="True" OnSelectedIndexChanged="ddlSched_SelectedIndexChanged"></asp:DropDownList></TD></TR>--%><TR><TD align=left colSpan=4><asp:Label id="lblSched" runat="server" ForeColor="Navy" Font-Bold="True" Text="       Schedule" Font-Size="10pt" Font-Names="Verdana"></asp:Label> </TD></TR><TR><TD colSpan=4><asp:GridView id="gdvAOApprovSched" runat="server" Width="692px" ForeColor="#333333" Font-Size="10pt" Font-Names="Verdana" ShowFooter="True" CellSpacing="5" AutoGenerateColumns="False" GridLines="None" CellPadding="2"><Columns>
<asp:BoundField DataField="SlNo" HeaderText="SlNo">
<ItemStyle HorizontalAlign="Left"></ItemStyle>
</asp:BoundField>
