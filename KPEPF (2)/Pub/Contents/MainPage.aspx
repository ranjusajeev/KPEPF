<%@ page language="C#" masterpagefile="~/Contents/MasterPage.master" autoeventwireup="true" inherits="Contents_MainPage, App_Web_sldhjcan" title="Kerala Panchayat Employees Provident Fund" %>

    <asp:Content ID="Content1" ContentPlaceHolderID="contentPholder" runat="server">
<asp:UpdatePanel ID="updatepanel" runat= "server">
    <ContentTemplate>
<TABLE width="100%"><TBODY><TR>
<TD align=center ><asp:Label id="lblHead23" class="Head1" runat="server" Text="Inbox Count"></asp:Label> </TD>
<TD align=center><asp:Label id="lblHead" class="Head1" runat="server" Text="KPEPF Account"></asp:Label> </TD></TR>
