...
--%>
<%@ page language="C#" masterpagefile="~/Contents/MasterPage.master" autoeventwireup="true" inherits="Contents_InboxMembership, App_Web_vxnq-4wi" %>
...
<asp:HyperLink id="HyperLink1" runat="server" Text='<%# Eval("chvEmployeeName") %>' NavigateUrl='<%# Eval("numTrnID", "~/Contents/MembershipNomonation.aspx?MemReqID={0}") %>'></asp:HyperLink>
</ItemTemplate>
...
<asp:BoundField DataField="chvFileNo" HeaderText="File No.                ">
