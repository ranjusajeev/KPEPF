<%@ page language="C#" masterpagefile="~/Contents/MasterPage.master" autoeventwireup="true" inherits="Contents_OpeningBalance, App_Web_vxnq-4wi" title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="contentPholder" Runat="Server">
<asp:UpdatePanel ID="updatepanel" runat= "server">
    <ContentTemplate>
<TABLE style="WIDTH: 100%"><TBODY><TR><TD class="TdMnHead" colSpan=4>&nbsp;<asp:Label id="lblHead" class="MnHead" runat="server" Text="Opening Balance"></asp:Label> </TD></TR><TR><TD>&nbsp;</TD></TR><TR><TD>&nbsp;&nbsp;&nbsp;</TD><TD></TD><TD style="align: left"><asp:Label id="Year" runat="server" Text="District" CssClass="p1"></asp:Label></TD><TD style="align: left"><asp:DropDownList id="ddlDist" runat="server" Width="150px" AutoPostBack="True" OnSelectedIndexChanged="ddlDist_SelectedIndexChanged"></asp:DropDownList>&nbsp;&nbsp;&nbsp;<asp:Label id="lblCnt" runat="server" Text="..." CssClass="p4"></asp:Label></TD><TD></TD></TR><TR><TD>&nbsp;&nbsp;&nbsp;</TD><TD></TD><TD style="align: left"><asp:Label id="lbl1" runat="server" Text="Account No." CssClass="p1"></asp:Label></TD><TD style="align: left"><asp:TextBox id="txtAccNo" oncopy="return false" oncut="return false" tabIndex=4 onkeypress="return isNumberKey(event)" onpaste="return false" runat="server" Width="150px" CssClass="txtNumeric" AutoPostBack="True" MaxLength="5" OnTextChanged="txtAccNo_TextChanged"></asp:TextBox>&nbsp;&nbsp;&nbsp;<asp:Label id="lblAccNo" runat="server" Text="..." CssClass="p4"></asp:Label>&nbsp;&nbsp;&nbsp;<asp:Label id="lblName" runat="server" Text="..." CssClass="p4"></asp:Label></TD></TR><TR><TD>&nbsp;&nbsp;&nbsp;</TD><TD></TD><TD style="align: left"><asp:Label id="lbl2" runat="server" Text="Opening Balance" CssClass="p1"></asp:Label></TD><TD style="align: left"><asp:TextBox id="txtOb" runat="server" Width="150px" CssClass="txtNumeric" MaxLength="7"></asp:TextBox></TD><TD style="align: left"><asp:HiddenField id="hdnOb" runat="server"></asp:HiddenField></TD></TR><TR align=center><TD style="align: left" colSpan=4><asp:Button id="btnNew" onclick="btnNew_Click" runat="server" Width="50" Text="New"></asp:Button><asp:Button id="btnSave" onclick="btnSave_Click" runat="server" Width="50" Text="Save"></asp:Button> <asp:Button id="btnSearch" onclick="btnSearch_Click" runat="server" Width="50" Text="Search"></asp:Button> <asp:TextBox id="txtSearch" runat="server" Width="129px" CssClass="txtNumeric" AutoPostBack="True" MaxLength="5" OnTextChanged="txtSearch_TextChanged" ReadOnly="True"></asp:TextBox> </TD></TR><TR align=center><TD  align=center colSpan=4><asp:GridView id="gdvRecM" runat="server" ForeColor="#333333" Font-Names="Verdana" Font-Size="10pt" ShowFooter="True" CellSpacing="5" CellPadding="2" GridLines="None" AutoGenerateColumns="False">
