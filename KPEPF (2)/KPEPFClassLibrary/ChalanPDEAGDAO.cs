...
namespace KPEPFClassLibrary
{
    public class ChalanPDEAGDAO : KPEPFDAOBase
    {
        ...
        public DataSet RemitancechlntextfillPDE01Replacement(ArrayList ArrIn)
        {
            DataSet ds = new DataSet();
            ds = Fetch("AP_TreasuryDetailsLB_S8", CommandType.StoredProcedure, ArrIn);//Chalan_S1
            return ds;
        }
        public DataSet SaveChalandetailsPDE01(ChalanPDEAG chalanAG)
        {
            ...
            ArrIn.Add(chalanAG.IntFrmWhomId);
            ArrIn.Add(chalanAG.FlgUnPosted);
            ArrIn.Add(chalanAG.IntReasonID);
            try
            {
        ...
        public DataSet DeleteChalanPDE01Lat(ArrayList ArrIn)
        {
            DataSet ds = new DataSet();
            ds = Fetch("TB_ChalanDetails_TRN_D2", CommandType.StoredProcedure, ArrIn);//Chalan_S1
            return ds;
        }
        ...
        public DataSet DeleteChalanPDELat(ArrayList ArrIn)
        {
            DataSet ds = new DataSet();
            ds = Fetch("AP_TreasuryDetailsLB_D1", CommandType.StoredProcedure, ArrIn);//Chalan_S1
            return ds;
        }
        ...
        public DataSet getEditable(ArrayList ArrIn)
        {
            DataSet ds = new DataSet();
            ds = Fetch("AP_ChalanAG_S7", CommandType.StoredProcedure, ArrIn);
            return ds;
        }
    }
}
