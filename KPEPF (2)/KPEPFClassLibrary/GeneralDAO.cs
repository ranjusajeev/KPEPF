...
namespace KPEPFClassLibrary
{
    public class GeneralDAO :KPEPFDAOBase 
    {
        ...
        public DataSet GetYearCorr()
        {
            DataSet dsYr = new DataSet();
            dsYr = Fetch("G_Year_S19", CommandType.StoredProcedure);
            return dsYr;
        }
        ...
        public DataSet GetYearCorrCalc()
        {
            DataSet ds = new DataSet();
            ds = Fetch("G_Year_S2", CommandType.StoredProcedure);
            return ds;
        }
        ...
        public DataSet CCardNonTrn(ArrayList ArrIn)
        {
            DataSet ds = new DataSet();
            ds = Fetch("Pfo_RptCreditCardNonTrn", CommandType.StoredProcedure, ArrIn);
            return ds;
        }
        ...
        public DataSet CCardCorr(ArrayList ArrIn)
        {
            DataSet ds = new DataSet();
            ds = Fetch("TB_ChalanDetails_TRN_S16", CommandType.StoredProcedure, ArrIn);
            return ds;
        }
        ...
        public DataSet InterestMltpl(ArrayList arrIn)
        {
            DataSet ds = new DataSet();
            ds = Fetch("L_InterestRate_S6", CommandType.StoredProcedure, arrIn);
            return ds;
        } 
        ...
        public DataSet GetEmpLBWise(int LBId, int flg)
        {
        ...
        public DataSet GetLBChalwise(ArrayList arr)
        {
            DataSet dsLB = new DataSet();
            dsLB = Fetch("TB_LocalBody_MST_S14", CommandType.StoredProcedure, arr);
            return dsLB;
        }
        ...
        public DataSet getLbWithId(ArrayList arr)
        {
            DataSet dsLB = new DataSet();
        ...
        public void AddLocalBody(ArrayList arr)
        {
            Save("TB_LocalBody_MST_I", CommandType.StoredProcedure, arr);
        }
        public void DelLocalBody(ArrayList arr)
        {
            Save("TB_LocalBody_MST_D", CommandType.StoredProcedure, arr);
        }
        //-----------------------------------------------------------
        ...
        public DataSet getRetrnFilesDir(ArrayList ArrIn)
        {
            DataSet ds = new DataSet();
            ds = Fetch("ReturnedFiles_S2", CommandType.StoredProcedure, ArrIn);
            return ds;
        }
        ...
        public DataSet GetTENo(ArrayList ArrInTe)
        {
            string str = "";
            DataSet dsTe = new DataSet();
            dsTe = Fetch("AP_TEMonthWise_S3", CommandType.StoredProcedure, ArrInTe);
            return dsTe;
        }
        ...
        public DataSet FindNoOfMonthsNew(int yr)
        {
            int intCntM = 0;
            DataSet dsCntM = new DataSet();
            ArrayList arM = new ArrayList();
        ...
        public DataSet GetDet4MltplRt(int yr)
        {
            int intCntM = 0;
            DataSet dsCntM = new DataSet();
            ArrayList arM = new ArrayList();
        ...
        public DataSet GetReplicatesSched(ArrayList arr)
        {
            DataSet dsLB = new DataSet();
            dsLB = Fetch("Replicates_S3", CommandType.StoredProcedure, arr);
            return dsLB;
        }
        public DataSet GetReplicatesSched2(ArrayList arr)
        {
            DataSet dsLB = new DataSet();
            dsLB = Fetch("Replicates_S4", CommandType.StoredProcedure, arr);
            return dsLB;
        }
        public DataSet GetReplicatesSched3(ArrayList arr)
        {
            DataSet dsLB = new DataSet();
            dsLB = Fetch("Replicates_S5", CommandType.StoredProcedure, arr);
            return dsLB;
        }
        ...
        public DataSet GetDisTreasuryFull()
        {
            DataSet dsT = new DataSet();
            dsT = Fetch("G_TreasuryD_S5", CommandType.StoredProcedure);
            return dsT;
        }
        public DataSet GetDisTreasuryFullNew()
        {
            DataSet dsT = new DataSet();
            dsT = Fetch("AP_G_TreasuryDRec_S1", CommandType.StoredProcedure);
            return dsT;
        }
        

        public DataSet GetLBTreasWise(ArrayList arr)
        {
            DataSet dsT = new DataSet();
            dsT = Fetch("TB_LocalBody_MST_S9", CommandType.StoredProcedure,arr);
            return dsT;
        }
        public DataSet GetLBTreasWiseMapped(ArrayList arr)
        {
            DataSet dsT = new DataSet();
            dsT = Fetch("TB_LocalBody_MST_S11", CommandType.StoredProcedure, arr);
            return dsT;
        }
        public DataSet GetLBTreasWiseAll(ArrayList arr)
        {
            DataSet dsT = new DataSet();
            dsT = Fetch("TB_LocalBody_MST_S16", CommandType.StoredProcedure, arr);
            return dsT;
        }
        public void UpdateLBTreasury(ArrayList arr)
        {
            Save("TB_LocalBody_MST_U2", CommandType.StoredProcedure, arr);
        }
        public void UpdateLBTreasuryNull(ArrayList arr)
        {
            Save("TB_LocalBody_MST_U3", CommandType.StoredProcedure, arr);
        }
        public DataSet GetResult(string str)
        {
            DataSet dsS = new DataSet();
            try
            {
                Fetch(str, CommandType.Text);
                dsS = Fetch("GetResult", CommandType.StoredProcedure);
                return dsS;
            }
            catch (Exception E)
            {
        ...
        public void GetResultUpd(string str, ArrayList ar)
        {
            try
            {
                Fetch(str, CommandType.Text);
                Save("GetResultUpd", CommandType.StoredProcedure,ar);
            }
            catch (Exception E)
            {
                throw new Exception("Check the Error" + E.Message);
        ...
        public DataSet GetResultCol(ArrayList arr)
        {
            DataSet dsT = new DataSet();
            dsT = Fetch("GetResultCol", CommandType.StoredProcedure, arr);
            return dsT;
        }
        public DataSet GetSp(ArrayList arr)
        {
            DataSet dsLB = new DataSet();
            dsLB = Fetch("GetSp", CommandType.StoredProcedure, arr);
            return dsLB;
        }
        public void GetResultDelete()
        {
            //DataSet dsS = new DataSet();
            //dsS = Fetch("GetResultD", CommandType.StoredProcedure);
            //return dsS;

            Fetch("GetResultD", CommandType.StoredProcedure);
        }
        public void GetResultDeleteUpd()
        {
            Fetch("GetResultDUpd", CommandType.StoredProcedure);
        }
        public DataSet GetLB4Search(ArrayList arr)
        {
            DataSet dsLB = new DataSet();
            dsLB = Fetch("TB_LocalBody_MST_S13", CommandType.StoredProcedure, arr);
            return dsLB;
        }
        public void AddTreasury(ArrayList arr)
        {
            Save("G_Treasury_I", CommandType.StoredProcedure, arr);
        }
        public DataSet GetTreasuryFromId(ArrayList ar)
        {
            DataSet dsT = new DataSet();
            dsT = Fetch("G_Treasury_S5", CommandType.StoredProcedure, ar);
            return dsT;
        }
        public void DelTreasury(ArrayList arr)
        {
            Save("G_Treasury_D", CommandType.StoredProcedure, arr);
        }
        public DataSet getCorrDet(ArrayList ar)
        {
            DataSet dsT = new DataSet();
            dsT = Fetch("TB_LedgerDet_TRN_S5", CommandType.StoredProcedure, ar);
            return dsT;
        }
        public DataSet getCorrDetn(ArrayList ar)
        {
            DataSet dsT = new DataSet();
            dsT = Fetch("TB_LedgerDet_TRN_S6", CommandType.StoredProcedure, ar);
            return dsT;
        }
        public DataSet getCorrDetnSingle(ArrayList ar)
        {
            DataSet dsT = new DataSet();
            dsT = Fetch("TB_LedgerDet_TRN_S6_Single", CommandType.StoredProcedure, ar);
            return dsT;
        }
        public DataSet getCorrDetnSingleLat(ArrayList ar)
        {
            DataSet dsT = new DataSet();
            dsT = Fetch("LedgerMonthly_S8_Single", CommandType.StoredProcedure, ar);
            return dsT;
        }
        public DataSet getCorrDetnS(ArrayList ar)
        {
            DataSet dsT = new DataSet();
            dsT = Fetch("TB_LedgerDet_TRN_S8", CommandType.StoredProcedure, ar);
            return dsT;
        }
        public DataSet getCorrDetn2(ArrayList ar)
        {
            DataSet dsT = new DataSet();
            dsT = Fetch("LedgerMonthly_S8", CommandType.StoredProcedure, ar);
            return dsT;
        }
        public DataSet getRejList(ArrayList ar)
        {
            DataSet dsT = new DataSet();
            dsT = Fetch("ApprovalPDE_S9", CommandType.StoredProcedure, ar);
            return dsT;
        }
        public DataSet getRejListAg(ArrayList ar)
        {
            DataSet dsT = new DataSet();
            dsT = Fetch("AGEntries_S6", CommandType.StoredProcedure, ar);
            return dsT;
        }
        public DataSet getCardCons()
        {
            DataSet dsT = new DataSet();
            dsT = Fetch("LedgerYearly_S7", CommandType.StoredProcedure);
            return dsT;
        }

        public void UpdateLBName(ArrayList arr)
        {
            Save("TB_LocalBody_MST_U4", CommandType.StoredProcedure, arr);
        }
        public void AddLB(ArrayList arr)
        {
            Save("TB_LocalBody_MST_I1", CommandType.StoredProcedure, arr);
        }
        public void UpdLBTreasYrWise(ArrayList arr)
        {
            Save("Chalan_U5", CommandType.StoredProcedure, arr);
        }
        public DataSet getCalcGroup()
        {
            DataSet dsT = new DataSet();
            dsT = Fetch("L_EmployeeDet_S21", CommandType.StoredProcedure);
            return dsT;
        }
        public DataSet getBillDet(ArrayList arr)
        {
            DataSet dsT = new DataSet();
            dsT = Fetch("Withdrawals_S14", CommandType.StoredProcedure, arr);
            return dsT;
        }
        public DataSet getWithDet(ArrayList arr)
        {
            DataSet dsT = new DataSet();
            dsT = Fetch("Withdrawals_S15", CommandType.StoredProcedure, arr);
            return dsT;
        }
        public void updWithModeOfChange(ArrayList arr)
        {
            Save("Withdrawals_U2", CommandType.StoredProcedure, arr);
        }
        ...
        public DataSet GetResultFromString(string str)
        {
            DataSet ds = new DataSet();
            ds = Fetch(str, CommandType.Text);
            return ds;
        }
