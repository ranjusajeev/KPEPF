...
namespace KPEPFClassLibrary
{
    public class ChalanDAO : KPEPFDAOBase 
    {
        ...
        public DataSet FillCrPlusNw(ArrayList ArrIn)
        {
            DataSet ds = new DataSet();
            ds = Fetch("ChalanAG_S3", CommandType.StoredProcedure, ArrIn);
            return ds;
        }
        ...
        public DataSet APChalanAGDelTrn(ArrayList ArrIn)
        {
            DataSet ds = new DataSet();
            ds = Fetch("TB_ChalanDetails_TRN_D2", CommandType.StoredProcedure, ArrIn);
            return ds;
        }
        ...
        //{
        //    DataSet ds = new DataSet();
        //    ds = Fetch("AP_ChalanAG_S6", CommandType.StoredProcedure, ArrIn);
        //    return ds;
        //}
        ...
        public DataSet Remitancechlntextfill14(ArrayList ArrIn)
        {
            DataSet ds = new DataSet();
            ds = Fetch("Chalan_S43", CommandType.StoredProcedure, ArrIn);//Chalan_S1
            return ds;
        }
        public DataSet RemitanceTextfill(ArrayList ArrIn)
        {
            DataSet ds = new DataSet();
            ds = Fetch("AP_TreasuryDetailsS_S3", CommandType.StoredProcedure, ArrIn);//Chalan_S1
            return ds;
        }
        ...
        public DataSet GetToolTipSlNo(ArrayList ar)
        {
            DataSet dsChal = new DataSet();
            dsChal = Fetch("TreasuryDEntries_S5", CommandType.StoredProcedure, ar);
            return dsChal;
        }
        ...
        public DataSet ChalanStatusLb(ArrayList ArrIn)
        {
            DataSet ds = new DataSet();
            ds = Fetch("Chalan_S42", CommandType.StoredProcedure, ArrIn);//Chalan_S1
            return ds;
        }
        ...
        //public DataSet RecPrint5(ArrayList ar)
        //{
        //    DataSet ds = new DataSet();
        //    ds = Fetch("Chalan_S37", CommandType.StoredProcedure, ar);//Chalan_S1
        //    return ds;
        //}
        public DataSet FindCntEmpInChalanCurr(ArrayList ar)
        {
            int cnt = 0;
            DataSet dsCnt = new DataSet();
            dsCnt = Fetch("Chalan_S36", CommandType.StoredProcedure, ar);
            return dsCnt;
        }
        public DataSet FindChalanTEDet(ArrayList ar)
        {
            int cnt = 0;
            DataSet dsCnt = new DataSet();
            dsCnt = Fetch("Chalan_S41", CommandType.StoredProcedure, ar);
            return dsCnt;
        }
        public DataSet FindChalanTEDetAg(ArrayList ar)
        {
            int cnt = 0;
            DataSet dsCnt = new DataSet();
            dsCnt = Fetch("Chalan_S45", CommandType.StoredProcedure, ar);
            return dsCnt;
        }
        public void UpdateChalanFrm(ArrayList arr)
        {
            try
            {
                Save("Chalan_U4", CommandType.StoredProcedure, arr);
            }
            catch (Exception E)
            {
                throw new Exception("Check the Error" + E.Message);
        ...
        public void UpdateChalanOtherFrm(ArrayList arr)
        {
            try
            {
                Save("ChalanOther_U", CommandType.StoredProcedure, arr);
            }
            catch (Exception E)
            {
                throw new Exception("Check the Error" + E.Message);
        ...
        public void UpdateChalan_C(ArrayList arr)
        {
            try
            {
                Save("Tr_Chalan_C_I", CommandType.StoredProcedure, arr);
            }
            catch (Exception E)
            {
                throw new Exception("Check the Error" + E.Message);
        ...
        public DataSet DelTr_Chalan_C(ArrayList ar)
        {
            DataSet dsChaln = new DataSet();
            dsChaln = Fetch("Tr_Chalan_C_D", CommandType.StoredProcedure, ar);
            return dsChaln;
        }

        public DataSet Processtracking(ArrayList ar) //Processtracking 01/04/22
        {
            DataSet ds = new DataSet();
            ds = Fetch("Processtracking_I", CommandType.StoredProcedure, ar);
            return ds;
        }
    }
}
