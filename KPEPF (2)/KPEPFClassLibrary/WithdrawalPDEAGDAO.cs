...
namespace KPEPFClassLibrary
{
    public class WithdrawalPDEAGDAO : KPEPFDAOBase
    {
        ...
        public DataSet GetWithdrawaEmpBind(WithdrawalPDEAG ag)
        {
            DataSet ds = new DataSet();
            ArrayList ar = new ArrayList();
            ar.Add(ag.IntVoucherAGID);
            ds = Fetch("Pfo_Withdrawal_S10", CommandType.StoredProcedure, ar);
            return ds;
        }
        ...
        {
            DataSet ds = new DataSet();
            ds = Fetch("AP_VoucherAG_S2", CommandType.StoredProcedure, ArrIn);
            return ds;
        }
        public void delWithPDE(ArrayList ArrIn)
        {
            Fetch("Pfo_Withdrawal_D1", CommandType.StoredProcedure, ArrIn);
        }
        public DataSet withPDEForCorrectionEntry(ArrayList ArrIn)
        {
            DataSet ds = new DataSet();
            ds = Fetch("Pfo_Withdrawal_S11", CommandType.StoredProcedure, ArrIn);
            return ds;
        }
    }
}
