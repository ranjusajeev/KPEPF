...
namespace KPEPFClassLibrary
{
    public class WithdrawalPDEDAO : KPEPFDAOBase
    {
        ...
        public DataSet UpdateWithPde1(WithdrawalPDE withdr)
        {
            ...
            ArIn1.Add(withdr.ChvOdrNoDtOfPrevTA);
            ArIn1.Add(withdr.FltAmtPrevTA);
            try
            {
        ...
        public DataSet getBillEmps(ArrayList arr)
        {
            DataSet ds = new DataSet();
            ds = Fetch("Pfo_Withdrawal_S9", CommandType.StoredProcedure, arr);
            return ds;
        }
    }
}
