...
namespace KPEPFClassLibrary
{
    public class MembershipDAO : KPEPFDAOBase
    {
        ...
        public DataSet GetRelationshipAll()
        {
            DataSet ds = new DataSet();
            ds = Fetch("G_Relationship_S2", CommandType.StoredProcedure);
            return ds;
        }
        ...
        public DataSet GetInBoxMemDir(ArrayList ArrIn)
        {
            DataSet ds = new DataSet();
            ds = Fetch("MembershipRequest_S5", CommandType.StoredProcedure, ArrIn);
            return ds;
        }
        public DataSet GetInBoxMemAcc(ArrayList ArrIn)
        {
            DataSet ds = new DataSet();
            ds = Fetch("MembershipRequest_S6", CommandType.StoredProcedure, ArrIn);
            return ds;
        }
