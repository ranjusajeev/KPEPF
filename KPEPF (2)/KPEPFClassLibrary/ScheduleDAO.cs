...
namespace KPEPFClassLibrary
{
    public class ScheduleDAO : KPEPFDAOBase 
    {
        ...
        public DataSet GetMaxScheduleId()
        {
            DataSet ds = new DataSet();
            ds = Fetch("Tb_ScheduleTR104_S10", CommandType.StoredProcedure);
            return ds;
        }
        public DataSet GetSchedDet4CorrEntryCurrCorr(ArrayList ArrIn)
        {
            DataSet ds = new DataSet();
            ds = Fetch("ScheduleTR104_S12", CommandType.StoredProcedure, ArrIn);
            return ds;
        }
        public DataSet UpdScheduleDel(ArrayList ArrIn)
        {
            DataSet ds = new DataSet();
            ds = Fetch("ScheduleTR104_U1", CommandType.StoredProcedure, ArrIn);
            return ds;
        }
