<%@ page language="C#" masterpagefile="~/Contents/MasterPage.master" autoeventwireup="true" inherits="Contents_Localbody, App_Web_1la5evxf" title="Untitled Page" %>
       ...
       <TABLE style= "width:900px">
           ...
           <TR >
               ...
               <asp:TextBox ID="txtResult" runat="server" TextMode="MultiLine" Height="74px" Width="509px"></asp:TextBox>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                   ...
                   <asp:Button id="btnUpdT" onclick="btnUpdT_Click" runat="server" Width="77px" Text="Get Result"></asp:Button>
