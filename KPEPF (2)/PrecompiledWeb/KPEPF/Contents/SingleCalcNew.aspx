<%@ page language="C#" masterpagefile="~/Contents/MasterPage.master" autoeventwireup="true" inherits="Contents_SingleCalcNew, App_Web_1la5evxf" title="Untitled Page" %>
...
<%--  </TD>
  <TD align=center>--%>
      <asp:Button id="btnBulkNew" onclick="btnBulkNew_Click" runat="server" Width="86px" ForeColor="Blue" Font-Bold="True" Text="Single Calc" Font-Size="10pt" Font-Names="Verdana"></asp:Button>
    <asp:Button id="btnLWACalc" onclick="btnLWACalc_Click" runat="server" Width="132px" ForeColor="Blue" Font-Bold="True" Text="Single Calc_LWA" Font-Size="10pt" Font-Names="Verdana"></asp:Button>
</TD>
