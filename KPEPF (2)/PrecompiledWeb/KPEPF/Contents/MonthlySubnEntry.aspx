<%@ page language="C#" masterpagefile="~/Contents/MasterPage.master" autoeventwireup="true" inherits="Contents_MonthlySubnEntry, App_Web_rihpu3hj" title="Untitled Page" %>
...
<asp:TextBox id="txtAccNo" oncopy="return false" oncut="return false" onkeypress="return  isNumberKey(event)" onpaste="return false" runat="server" Width="76px" AutoPostBack="True" MaxLength="6" OnTextChanged="txtAccNo_TextChanged" CssClass="txtNumeric" __designer:wfdid="w5"></asp:TextBox> 
</ItemTemplate>
</asp:TemplateField>
...
<asp:TextBox id="txtRep" oncopy="return false" oncut="return false" onkeypress="return  isNumberKey(event)" onpaste="return false" runat="server" Width="60px" AutoPostBack="True" CssClass="txtNumeric" OnTextChanged="txtRep_TextChanged" MaxLength="6"></asp:TextBox> 
</ItemTemplate>
...
<asp:TextBox id="txtArr3" oncopy="return false" oncut="return false" onkeypress="return  isNumberKey(event)" onpaste="return false" runat="server" Width="60px" AutoPostBack="True" CssClass="txtNumeric" OnTextChanged="txtArr3_TextChanged" MaxLength="6"></asp:TextBox> 
</ItemTemplate>
