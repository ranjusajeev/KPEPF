...
<%@ page title="" language="C#" masterpagefile="~/Contents/MasterPage.master" autoeventwireup="true" inherits="Contents_CreditCardVeri, App_Web_rihpu3hj" %>
...
<asp:Label id="Label9" runat="server" Width="120px" Text="Year" CssClass="p1">
 ...
 &nbsp;&nbsp;&nbsp;
     <asp:Button id="btnTemp" onclick="btnTemp_Click" Enabled="false" runat="server" Width="86px" ForeColor="Blue" Font-Bold="True" Text="Temp" Font-Size="10pt" Font-Names="Verdana"></asp:Button>
    <asp:Button id="btnGrid" onclick="btnGrid_Click"  Enabled="false" runat="server" Width="86px" ForeColor="Blue" Font-Bold="True" Text="Grid" Font-Size="10pt" Font-Names="Verdana"></asp:Button>
    <asp:Button id="btnCorrCalc" onclick="btnCorrCalc_Click" runat="server" Width="86px" ForeColor="Blue" Font-Bold="True" Text="Corr Cal" Font-Size="10pt" Font-Names="Verdana"></asp:Button>
