...
namespace KPEPFClassLibrary
{
    public class BillPDE
    {
        ...
        public int IntDTreasuryId
        {
            get
            {
                return this.intDTreasuryId;
            }
            set
            {
                intDTreasuryId = value;
            }
        }
        ...
        public int IntSearchType
        {
            get
            {
                return this.intSearchType;
            }
            set
            {
                intSearchType = value;
